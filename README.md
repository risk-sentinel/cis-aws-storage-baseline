...
[![Quality gate](https://sonarcloud.io/api/project_badges/quality_gate?project=risk-sentinel_cis-aws-storage-baseline)](https://sonarcloud.io/summary/new_code?id=risk-sentinel_cis-aws-storage-baseline)
...
curl -LO https://github.com/risk-sentinel/cis-aws-storage-baseline/releases/download/$VERSION/cis-aws-storage-v1.0.0-$VERSION.tar.gz

# then, on the isolated side
mkdir -p cis-aws-storage-v1.0.0 && tar xzf cis-aws-storage-v1.0.0-$VERSION.tar.gz -C cis-aws-storage-v1.0.0
cd cis-aws-storage-v1.0.0
...
```yaml
uses: risk-sentinel/cis-aws-storage-baseline/.github/workflows/exec-evidence.yml@<version>
with:
  profile_source: archive
  archive_path: ./cis-aws-storage-v1.0.0-<version>.tar.gz
```
...
```yaml
include:
  - project: <your-org>/cis-aws-storage-baseline
    ref: <version>
