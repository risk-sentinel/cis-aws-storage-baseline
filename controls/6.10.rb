...
control 'C-6.10' do
  ...
  describe 'Ensure execution of a Disaster Recovery Failover' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0610r1_rule.'
  end
end
