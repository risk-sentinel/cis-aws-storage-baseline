...
control 'C-6.3' do
  ...
  describe 'Ensure functionality of Endpoint Detection and Response (EDR)' do
    skip 'TODO[scaffolder]: implement check against XCCDF check-content. Source rule SV-0603r1_rule.'
  end
end
